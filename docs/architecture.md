...
| Component | Role |
| --- | --- |
| Coinbase WebSocket producer | Captures live public crypto trade events and writes them directly to Kafka |
...
Input records use a compact exchange-neutral trade shape:
...
| notional_volume | Sum of trade value in USD |
